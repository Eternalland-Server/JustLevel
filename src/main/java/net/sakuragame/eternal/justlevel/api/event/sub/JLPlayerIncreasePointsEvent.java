...
@Getter
@Setter
public class JLPlayerIncreasePointsEvent extends JustLevelEvent implements Cancellable {

    private final LevelDefine define;
    private int points;
    private boolean cancel;

    public JLPlayerIncreasePointsEvent(Player player, LevelDefine define, int points) {
        super(player);
        this.define = define;
        this.points = points;
        this.cancel = false;
